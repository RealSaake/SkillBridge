    ...
    return measurePerformance('fetchUserRepositories', async () => {
      ...
      try {
        ...
        for (const repo of repositories) {
          // Comprehensive GitHub repository schema to prevent security warnings
          const repoValidation = validator.validate(repo, {
            ...
            svn_url: { type: 'string' as const, required: false },
            mirror_url: { type: 'string' as const, required: false },
            homepage: { type: 'string' as const, required: false },
            size: { type: 'number' as const, required: false, min: 0 },
            watchers_count: { type: 'number' as const, required: false, min: 0 },
            watchers: { type: 'number' as const, required: false, min: 0 },
            open_issues_count: { type: 'number' as const, required: false, min: 0 },
            open_issues: { type: 'number' as const, required: false, min: 0 },
            forks: { type: 'number' as const, required: false, min: 0 },
            archived: { type: 'boolean' as const, required: false },
            disabled: { type: 'boolean' as const, required: false },
            pushed_at: { type: 'string' as const, required: false },
            created_at: { type: 'string' as const, required: false },
            default_branch: { type: 'string' as const, required: false },
            permissions: { type: 'object' as const, required: false },
            allow_rebase_merge: { type: 'boolean' as const, required: false },
            allow_squash_merge: { type: 'boolean' as const, required: false },
            allow_merge_commit: { type: 'boolean' as const, required: false },
            allow_forking: { type: 'boolean' as const, required: false },
            web_commit_signoff_required: { type: 'boolean' as const, required: false },
            subscribers_count: { type: 'number' as const, required: false, min: 0 },
            network_count: { type: 'number' as const, required: false, min: 0 },
            topics: { type: 'array' as const, required: false },
            visibility: { type: 'string' as const, required: false },
            has_issues: { type: 'boolean' as const, required: false },
            has_projects: { type: 'boolean' as const, required: false },
            has_wiki: { type: 'boolean' as const, required: false },
            has_pages: { type: 'boolean' as const, required: false },
            has_downloads: { type: 'boolean' as const, required: false },
            has_discussions: { type: 'boolean' as const, required: false },
            is_template: { type: 'boolean' as const, required: false },
            license: { type: 'object' as const, required: false },
            fork: { type: 'boolean' as const, required: false },
            url: { type: 'string' as const, required: false },
            archive_url: { type: 'string' as const, required: false },
            assignees_url: { type: 'string' as const, required: false },
            blobs_url: { type: 'string' as const, required: false },
            branches_url: { type: 'string' as const, required: false },
            collaborators_url: { type: 'string' as const, required: false },
            comments_url: { type: 'string' as const, required: false },
            commits_url: { type: 'string' as const, required: false },
            compare_url: { type: 'string' as const, required: false },
            contents_url: { type: 'string' as const, required: false },
            contributors_url: { type: 'string' as const, required: false },
            deployments_url: { type: 'string' as const, required: false },
            downloads_url: { type: 'string' as const, required: false },
            events_url: { type: 'string' as const, required: false },
            forks_url: { type: 'string' as const, required: false },
            git_commits_url: { type: 'string' as const, required: false },
            git_refs_url: { type: 'string' as const, required: false },
            git_tags_url: { type: 'string' as const, required: false },
            hooks_url: { type: 'string' as const, required: false },
            issue_comment_url: { type: 'string' as const, required: false },
            issue_events_url: { type: 'string' as const, required: false },
            issues_url: { type: 'string' as const, required: false },
            keys_url: { type: 'string' as const, required: false },
            labels_url: { type: 'string' as const, required: false },
            languages_url: { type: 'string' as const, required: false },
            merges_url: { type: 'string' as const, required: false },
            milestones_url: { type: 'string' as const, required: false },
            notifications_url: { type: 'string' as const, required: false },
            pulls_url: { type: 'string' as const, required: false },
            releases_url: { type: 'string' as const, required: false },
            stargazers_url: { type: 'string' as const, required: false },
            statuses_url: { type: 'string' as const, required: false },
            subscribers_url: { type: 'string' as const, required: false },
